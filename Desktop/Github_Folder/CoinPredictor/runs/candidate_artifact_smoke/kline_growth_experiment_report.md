...
## Artifact Coverage
- Candidate artifact: `C:\Users\alexa\OneDrive\Desktop\GitHub_Files\Desktop\Github_Folder\CoinPredictor\runs\candidate_artifact_smoke\kline_growth_candidates.csv.gz`
- Candidate artifact rows: `3`
- Candidate artifact full coverage: `1`
- Portfolio ledger: ``
- Portfolio events: `0`
- Reconciliation status: ``
- Drawdown precision: `legacy_approximate`
- Exact realized drawdown: `0.000000`
- Mark-to-market drawdown available: `0`
- Maximum capital utilization: `0.000000`
- Maximum per-symbol exposure: `0.000000`
...
- Ranking rows available: `3`
- Score sources: `calibrated_probability,expected_value,hybrid_score,predicted_net_return,probability,ranker_score,ranker_selection_score,ranker_utility_score,trade_score`
- Trade-score top decile net return after costs: `0.000000`
- Trade-score top 1% net return after costs: `0.000585`
- Trade-score top 5% net return after costs: `0.000585`
...
- Ranker-score top 1% net return after costs: `0.006642`
- Ranker-score top 5% net return after costs: `0.006642`
- Ranker-score net-return monotonicity: `0.5000`
- Ranker-score tail warning: `non_monotonic_deciles`
...
- Gate action: `warn`
- Gate status: `failed`
- Failed checks: `trade_count 0 < 10; top_month_share 1.0000 > 0.7000; tail_monotonicity 0.0000 < 0.6000`
- Strength label: `robustness_rejected`

## Regime Summary
- Best regime by avg trade return: `btc_direction:negative`
- Worst regime by avg trade return: `btc_direction:negative`
- Best regime by profit: `btc_direction:negative`
- Worst regime by profit: `btc_direction:negative`
